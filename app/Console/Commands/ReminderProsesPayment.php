...
class ReminderProsesPayment extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reminder:proses-payment';
    ...
    public function handle()
    {
        ...
        $proses = KasPayment::where('status', 'process')->get();
        foreach ($proses as $data) {
            ...
            foreach ($notifPengurus as $notif_pengurus) {
                ...
                $messagePengurus = "*Pengingat : Notifikasi Pembayaran Kas Baru*\n";
