...
class SetorTunaiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // $fullDescription .= "- Total Konter: Rp" . number_format($konterTotal, 0, ',', '.') . "\n";
    ...
    public function detail_reject(string $id)
    {
        ...
        return view('user.setor_tunai.detail_reject', compact('deposit', 'data_kas', 'data_loanRepayment', [
            'kasData' => $kasData,
            'loanData' => $loanData,
        ]));
    }
    ...
    public function show_confirm(String $id)
    {
        ...
        return view('user.setor_tunai.konfirmasi', compact('deposit', 'data_kas', 'data_loanRepayment'));
    }
