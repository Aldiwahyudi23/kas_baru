            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form class="statusMenu" method="POST">
                            ...
                            <button type="button" class="btn {{ $data && $data->is_active ? 'btn-success' : 'btn-danger' }}"
                                data-url="{{ route('menu.toggleStatus', Crypt::encrypt($data->id)) }}"
                    ...
                    <td class="project-actions text-right">
                        <a class="btn btn-primary btn-sm" href="{{route('menu.show',Crypt::encrypt($data->id))}}">
                            <i class="fas fa-folder">
                            </i>
                            View
                        </a>
                        <a class="btn btn-info btn-sm" href="{{route('menu.edit',Crypt::encrypt($data->id))}}">
                            <i class="fas fa-pencil-alt">
                            </i>
                            Edit
                        </a>
                        <a class="btn btn-danger btn-sm" href="{{route('menu.destroy',Crypt::encrypt($data->id))}}" class="btn btn-danger" data-confirm-delete="true">
