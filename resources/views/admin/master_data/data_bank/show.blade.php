                    ...
                    <div class="tab-pane" id="settings">
                        <form id="anggaran-form" class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="label_anggaran" id="label_anggaran"
                                        placeholder="Tambah Label anggaran">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="catatan_anggaran" class="col-sm-2 col-form-label">Catatan</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="catatan_anggaran" name="catatan_anggaran"
                            ...
                            <tbody>
                                ...
                                <tr id="row-{{$data->id}}">
                                    ...
                                    <td class="project-actions text-right">
                                        <button class="btn btn-info btn-sm edit-anggaran"
                                            data-url="{{ route('anggaran_setting_update', Crypt::encrypt($data->id)) }}"
                                            data-id="{{ $data->id }}" data-label="{{ $data->label_anggaran }}"
                                            data-catatan="{{ $data->catatan_anggaran }}">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        .label_anggaran); // Update Label
                        row.find('td:eq(2)').text(result.value
                        .catatan_anggaran); // Update Catatan
