            ...
            <div class="card-header">
                <div class="text-center">
                    <img class="profile-user-img img-fluid img-circle"
                        src="{{asset('storage/'. $dataUser->profile_photo_path)}}"
        ...
        <div class="card">
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Data Lain</a></li>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="active tab-pane" id="activity">
                        <div class="card-body">
                            <form action="{{ route('user.update',Crypt::encrypt($dataUser->id)) }}" method="POST" enctype="multipart/form-data" id="adminForm">
                                @method('PATCH')
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" value="{{old('name',$dataUser->name)}}" class="form-control col-12 @error('name') is-invalid @enderror">
                                        </div>
                                        <div class="form-group">
                                            <label for="role_id">role_id <span class="text-danger">*</span></label>
                                            <select class="form-control select2bs4 col-12 @error('role_id') is-invalid @enderror" name="role_id">
                                                @if(old('role_id',$dataUser->role_id) == true)
                                                <option selected="selected" value=" {{old('role_id',$dataUser->role_id)}}">{{old('role_id',$dataUser->role->name)}}</option>
                                                @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="foto" id="foto" value="{{old('foto',$dataUser->foto)}}" class="form-control col-12 @error('foto') is-invalid @enderror">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label for="no_hp">No Handphone /Whatsapp</label>
                                            <input type="text" name="no_hp" id="no_hp" value="{{old('no_hp',$dataUser->no_hp)}}" class="form-control col-12 @error('no_hp') is-invalid @enderror">
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email</label>
                                            <input type="email" name="email" id="email" value="{{old('email',$dataUser->email)}}" class="form-control col-12 @error('email') is-invalid @enderror">
                                        </div>
                                        <div class="form-group">
                                            <label for="password">Reset Kata Sandi</label>
                                            <input type="password" name="password" id="password" value="{{old('password')}}" class="form-control col-12 @error('password') is-invalid @enderror">
                                        </div>
                                    </div>
                                </div>
