    ...
    <div class="col-md-3">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class=" text-center">{{$DataRole->name}}</h3>
                <p class="text-muted text-center">{{$DataRole->code}}</p>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <strong></i> Status</strong>
                @if($DataRole->is_active == 1)
                <p class="text-muted">
                    Aktif
                </p>
                @else
        ...
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                ...
                <p class="text-muted text-center">Data User yang terhubung ke Program</p>
                <ul class="list-group list-group-unbordered mb-3">
                    @foreach($user as $data)
                    <a href="{{route('user.show',Crypt::encrypt($data->id))}}">
                ...
                <div class="tab-content">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="project-actions text-right">
                                        <button class="btn btn-info btn-sm edit-program" data-url="{{ route('user.update', Crypt::encrypt($data->id)) }}" data-id="{{ $data->id }}" data-label="{{ $data->label_program }}" data-catatan="{{ $data->catatan_program }}">
                    ...
                    <div class="tab-pane" id="settings">
                        <form id="program-form" class="form-horizontal">
                            ...
                            <input type="hidden" name="program_id" value="{{$DataRole->id}}">
                            <div class="form-group row">
