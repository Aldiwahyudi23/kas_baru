            <div class="card-body">
                <form action="{{ route('program.store') }}" method="POST" enctype="multipart/form-data" id="adminForm">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="created" id="created" value="{{old('created')}}" class="form-control col-12 @error('created') is-invalid @enderror">
                            </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea class="summernote-textarea form-control col-12 @error('snk') is-invalid @enderror" name="snk" id="snk">{{ old('snk') }}</textarea>
                                </div>
                            </div>
