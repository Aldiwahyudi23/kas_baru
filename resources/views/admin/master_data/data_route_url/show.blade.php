    ...
    <div class="col-md-3">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">{{$DataRouteUrl->name}}</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <strong><i class="fas fa-book mr-1"></i> Nama Route</strong>
                <p class="text-muted">
                    {{$DataRouteUrl->route_name}}
                </p>
                <hr>
                <strong><i class="fas fa-clock mr-1"></i> Waktu Input</strong>
                <p class="text-muted">
                    {{$DataRouteUrl->created_at}}
                </p>
                <hr>
                <strong><i class="fas fa-clock mr-1"></i> Terakhir Update</strong>
                <p class="text-muted">
                    {{$DataRouteUrl->updated_at}}
                </p>
                <hr>
                <strong></i> Menu</strong>
