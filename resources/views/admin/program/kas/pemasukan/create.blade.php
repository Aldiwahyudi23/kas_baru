            <div class="card-body">
                <form action="{{ route('kas-payment.store') }}" method="POST" enctype="multipart/form-data" id="adminForm">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="payment_date" id="payment_date" value="{{old('payment_date')}}" class="form-control col-12 @error('payment_date') is-invalid @enderror">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2bs4 @error('data_warga_id') is-invalid @enderror" style="width: 100%;" name="data_warga_id" id="data_warga_id">
                                    ...
                                    <option value="{{$data->data_warga_id}}" {{ old('data_warga_id') == $data->data_warga_id ? 'selected' : '' }}
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2bs4 @error('payment_method') is-invalid @enderror" style="width: 100%;" name="payment_method" id="payment_method" onchange="toggleTransferReceipt()">
                            ...
                            <div class="form-group" id="transfer_receipt" style="display: {{ old('payment_method') == 'transfer' ? 'block' : 'none' }};">
                                <label for="transfer_receipt_path">Upload Bukti Transfer</label>
                                <input type="file" name="transfer_receipt_path" id="transfer_receipt_path" accept="image/*" class="form-control col-12 @error('transfer_receipt_path') is-invalid @enderror">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2bs4 @error('confirmed_by') is-invalid @enderror" style="width: 100%;" name="confirmed_by" id="confirmed_by">
                                    <option value="">--Pilih Data--</option>
                                    @foreach ($pengurus_user as $data)
                                    <option value="{{$data->data_warga_id}}" {{ old('confirmed_by') == $data->data_warga_id ? 'selected' : '' }}
                                        @if($data->is_active == 0) disabled @endif>
                                        {{ $data->name }}
                                        @if($data->is_active == 0) (Tidak Aktif) @endif
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2bs4 @error('status') is-invalid @enderror" style="width: 100%;" name="status" id="status">
                                    ...
                                    <option value="confirmed" {{ old('status') == 'confirmed' ? 'selected' : '' }}>Konfirmasi</option>
                                    <option value="rejected" {{ old('status') == 'rejected' ? 'selected' : '' }} disabled>Rejected</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label for="confirmation_date">Tanggal di Konfirmasi <span class="text-danger">*</span></label>
                                <input type="date" name="confirmation_date" id="confirmation_date" value="{{old('confirmation_date')}}" class="form-control col-12 @error('confirmation_date') is-invalid @enderror">
                            </div>


                            <div class="form-group">
                                <label for="is_deposited">Uang di luar</label>
                                <select class="select2bs4 @error('is_deposited') is-invalid @enderror" style="width: 100%;" name="is_deposited" id="is_deposited">
                                    <option value="">--Pilih Deposito--</option>
                                    <option value="0" {{ old('is_deposited') == '0' ? 'selected' : '' }}>False</option>
                                    <option value="1" {{ old('is_deposited') == '1' ? 'selected' : '' }}>Deposit</option>
                                </select>
                            </div>
