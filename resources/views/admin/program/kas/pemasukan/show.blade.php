    ...
    <div class="col-md-3">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class=" text-center">{{$dataKas->data_warga->name}}</h3>
                <p class="text-muted text-center">{{$dataKas->code}}</p>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <strong><i class="fas fa-clock mr-1"></i> Tanggal Di Buat</strong>
                <p class="text-muted">
                    {{$dataKas->payment_date}}
                </p>
                <hr>
                <strong>Di Input Oleh</strong>
                <p class="text-muted">
                    {{$dataKas->submitted->name ?? null}}
                </p>
                <hr>
                <strong></i> Status</strong> <br>
                @if($dataKas->status === 'confirmed')
                <span class="badge badge-success">Confirmed</span>
                @elseif($dataKas->status === 'pending')
                <span class="badge badge-warning">Pending</span>
                @elseif($dataKas->status === 'rejected')
                <span class="badge badge-danger">Rejected</span>
                @elseif($dataKas->status === 'process')
                    ...
                    <div class="active tab-pane" id="descrip">
                        ...
                        <div class="post">
                            <div class="user-block">
                                ...
                                <span class="description">{{$dataKas->status}} - 7:30 PM today</span>
                            </div>
                            <!-- /.user-block -->
                            <p>
                                {!!$dataKas->description!!}
                        ...
                        <div class="timeline timeline-inverse">
                            ...
                            <div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <h3 class="timeline-header"> {{$dataKas->code}}</h3>

                                    <div class="timeline-body">
                                        Nama Anggota {{$dataKas->data_warga->name}} <br>
                                        Nominal {{$dataKas->amount}} <br>
                                        Pembayaran {{$dataKas->payment_method}}
                                    </div>
                                </div>
                            </div>
                            <!-- END timeline item -->
                            ...
                            <div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-body">
                                        Tanggal di Konfirmasi : {{$dataKas->confirmation_date}} <br>
                                        Status Konfirmasi : @if($dataKas->status === 'confirmed')
                                        <span class="badge badge-success">Confirmed</span>
                                        @elseif($dataKas->status === 'pending')
                                        <span class="badge badge-warning">Pending</span>
                                        @elseif($dataKas->status === 'rejected')
