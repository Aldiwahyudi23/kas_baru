    ...
    <div class="col-md-3">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class=" text-center">{{$loan->warga->name}}</h3>
                <p class="text-muted text-center">{{$loan->code}}</p>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                    ...
                    <div class="active tab-pane" id="descrip">
                        ...
                        <div class="post">
                            <div class="user-block">
                                <img class="img-circle img-bordered-sm" src="{{'storage/'.$loan->ketua->foto}}" alt="user image">
                                <span class="username">
                        ...
                        <div class="timeline timeline-inverse">
                            ...
                            <div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <h3 class="timeline-header border-0"><a href="#">Di Input Oleh</a> {{$loan->created_at}}
                                    </h3>
                                </div>
                            </div>
                            <!-- END timeline item -->
                            ...
                            <div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <h3 class="timeline-header"> {{$loan->code}}</h3>
                            ...
                            <div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <h3 class="timeline-header border-0"><a href="#">Di Konfirmasi Oleh</a> {{$loan->ketua->name}}
                                    </h3>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <h3 class="timeline-header"><a href="#">Di Konfirmasi Oleh</a> {{$loan->ketua->name}}</h3>

                                    <div class="timeline-body">
                                        Tanggal di Konfirmasi : {{$loan->approved_date}} <br>
                                        Status Konfirmasi : @if($loan->status === 'confirmed')
                                        <span class="badge badge-success">Confirmed</span>
                                        @elseif($loan->status === 'pending')
                                        <span class="badge badge-warning">Pending</span>
                                        @elseif($loan->status === 'rejected')
                    ...
                    <div class="tab-pane" id="settings">
                        <div class="col-sm-12">
                            <a href="{{asset('storage/'.$loan->disbursement_receipt_path)}}" data-toggle="lightbox" data-title="Tanda Bukti" data-gallery="gallery">
                                <img src="{{asset('storage/'.$loan->disbursement_receipt_path)}}" class="img-fluid mb-12" alt="Tanda Bukti" />
                            </a>
                        </div>
                    </div>
                    <!-- /.tab-pane -->
