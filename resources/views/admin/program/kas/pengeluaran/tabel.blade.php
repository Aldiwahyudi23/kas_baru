            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="project-actions text-right">
                        <a class="btn btn-primary btn-sm" href="{{route('expenditure.show',Crypt::encrypt($data->id))}}">
                        ...
                        <a class="btn btn-danger btn-sm" href="{{route('expenditure.destroy',Crypt::encrypt($data->id))}}" class="btn btn-danger" data-confirm-delete="true">
