                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="phone" id="phone" value="{{old('phone')}}" class="form-control col-12 @error('phone') is-invalid @enderror">
                        </div>
                        <div class="form-group">
                            <label for="amount">amount</label>
                            <input type="number" name="amount" id="amount" value="{{old('amount')}}" class="form-control col-12 @error('amount') is-invalid @enderror">
                        </div>
