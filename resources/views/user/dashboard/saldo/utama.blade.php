...
<div class="alert alert-light border">
    <div class="row">
        <div class="col-md-4 border-right">
            <div class="p-3">
                <h5 class="font-weight-bold text-dark mb-2"><i class="fas fa-wallet mr-2"></i>Saldo Aktual Kas</h5>
                <h4 class="text-success mb-1">Rp {{ number_format($totalActualBalance, 2, ',', '.') }}</h4>
                <small class="text-muted d-block">Total saldo aktual semua rekening bank</small>
                <small class="text-muted">Update: {{ now()->format('d M Y H:i') }}</small>
            </div>
        </div>
        <div class="col-md-4 border-right">
            <div class="p-3">
                <h5 class="font-weight-bold text-dark mb-2"><i class="fas fa-calculator mr-2"></i>Saldo Sistem</h5>
                <h4 class="{{ $systemBalance >= 0 ? 'text-info' : 'text-danger' }} mb-1">
                    Rp {{ number_format($systemBalance, 2, ',', '.') }}
                </h4>
        ...
        <div class="col-md-4">
            <div class="p-3">
                <h5 class="font-weight-bold text-dark mb-2"><i class="fas fa-balance-scale mr-2"></i>Selisih</h5>
                <h4 class="{{ $difference == 0 ? 'text-primary' : ($difference > 0 ? 'text-success' : 'text-danger') }} mb-1">
                    Rp {{ number_format(abs($difference), 2, ',', '.') }}
                    @if($difference != 0)
                    <span class="badge badge-{{ $difference > 0 ? 'success' : 'danger' }} ml-2">
